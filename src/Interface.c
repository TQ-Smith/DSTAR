...
void print_help() {
    ...
    fprintf(stderr, "\n");
    fprintf(stderr, "Prints to stdout by default.\n");
    fprintf(stderr, "\n");
    ...
    fprintf(stderr, "                                           Default 0. Weighted jackknife performed.\n");
    fprintf(stderr, "    -z,--standard                      Calculates parametric bootstrap with Z-distribution when -r is set.\n");
